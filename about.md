...
![Amol icon]({{ site.baseurl }}/assets/iMessage.png){:height="150" width="150"}
[<i class="fab fa-linkedin" title="Amol's Linked in Profile"></i>](https://www.linkedin.com/in/amol)
[<i class="fab fa-twitter" title="Amol's Twitter Profile"></i>](https://twitter.com/amol_vyawhare)
[<i class="fab fa-dev" title="Amol's DEV Profile"></i>](https://dev.to/amol)
